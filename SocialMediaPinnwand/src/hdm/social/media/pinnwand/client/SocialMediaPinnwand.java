...
/**
 * Diese Klasse stellt den Entry point f�r die SocialMediaPinnwand dar. 
 * 
 */
public class SocialMediaPinnwand implements EntryPoint {
	...
	/**
	 *  Stellt eine Verbindung �ber einen Proxy her
	 */
	...
	public void onModuleLoad() {		
		 ...
		 */
		/**
		 * �berpr�ft den Login Status --> Nach Deploy: GWT.getHostPageBaseURL() 
		 */
