...
public class ReportGeneratorAdministrationImpl extends RemoteServiceServlet implements ReportGeneratorAdministration  {
	...
	/**
	 * Erstelle einen String welches durch den Report als HTML repr�sentiert 
	 * 
	...
	public String createBeitragReport(String datumVon, String datumBis) throws IllegalArgumentException {
	    ...
	    /**
	     * Zeitraum der Report Suchanfrage in die Kopfzeile hinzuf�gen
	     */
	    ...
	    /**
	     * Zun�chst legen wir eine Kopfzeile f�r die Nutzer-Tabelle an.
	     */
	    ...
	    /**
	     * Nun werden s�mtliche Beitr�ge innerhalb eines Zeitraumes ausgelesen und Autor, Inhalt, Likes und 
	    ...
	    for (Beitrag beitrag : beitraege) {
	      ...
	      // Erste Spalte: Nachname und Vorname hinzuf�gen
	      ...
	      // Dritte Spalte: Kommentar-Anzahl hinzuf�gen
	    ...
	    /**
	     * �bergebe den erstellten Report dem HTMLReportWriter um HTML zu erzeugen
	     */
	    HTMLReportWriter writer = new HTMLReportWriter();
	    writer.process(result);
	    
	    /**
	     * Zum Schluss m�ssen wir noch den fertigen HTML-Report zur�ckgeben.
	     */
	...
	public String CreateNutzerReport(Nutzer n, String datumVon, String datumBis) throws IllegalArgumentException {
		...
		if (this.getPinnwandVerwaltung() == null)
		    ...
		    // Jeder Report hat einen Titel (Bezeichnung / �berschrift)
		    result.setTitle("Informationen �ber " + n.getVorname() + " " + n.getName());
